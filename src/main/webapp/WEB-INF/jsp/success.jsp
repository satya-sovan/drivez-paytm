            ...
            <div class="row">
                ...
                <h1>success</h1>
                    <table class="table table-condensed">
					  ...
					  <tr>
					    <td>BANKTXNID</td>
					    <td>${paytmResponseBeen.BANKTXNID}</td>
					  </tr>
						<tr>
					    <td>ORDERID</td>
					  ...
					  <tr>
					    <td>TXNTYPE</td>
					    <td>${paytmResponseBeen.TXNTYPE}</td>
					  </tr>
					  <tr>
					    <td>GATEWAYNAME</td>
					    <td>${paytmResponseBeen.GATEWAYNAME}</td>
					  </tr>
					  <tr>
					    <td>RESPCODE</td>
					  ...
					  <tr>
					    <td>BANKNAME</td>
					    <td>${paytmResponseBeen.BANKNAME}</td>
					  </tr>
					  <tr>
					    <td>MID</td>
					  ...
					  <tr>
					    <td>PAYMENTMODE</td>
					    <td>${paytmResponseBeen.PAYMENTMODE}</td>
					  </tr>
					  <tr>
					    <td>REFUNDAMT</td>
					    <td>${paytmResponseBeen.REFUNDAMT}</td>
					  </tr>
					  <tr>
					    <td>TXNDATE</td>
					    <td>${paytmResponseBeen.TXNDATE}</td>
					  </tr>					  
